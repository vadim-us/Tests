...
class Garden
{
    ...
    // private int $allTreeInGarden = 0;

    private array $fruitHarvest = ['apple' => [], 'pear' => []];
    // private $appleTreeInGarden = 0;
    // private $pearTreeInGarden = 0;
    ...
    function __construct(int $appleTree = 10, int $pearTree = 15)
    {
        ...
        // $t = AppleTree::min_harvest;
        // $t5 = AppleTree::max_harvest;
    ...
    /* private function FillGarden(int $appleTree = 10, int $pearTree = 15)
    {
        $allTree = $appleTree + $pearTree;
    ...
    /* private function RandomTree(): Tree
    {
        rand(new AppleTree(), new PearTree());
        return
        new AppleTree($countApple);
    } */
